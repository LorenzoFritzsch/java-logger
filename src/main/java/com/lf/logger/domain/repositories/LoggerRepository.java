...
public interface LoggerRepository {
     ...
     * @param machineName the name of the machine, for fleet management
     * @param tag the main tag of the context
     * @param context the specific context
     * @param message the message explaining the error
     */
    void e(String UTCTime, String machineName, String tag, String context, String message); //TODO: Add machine name for fleet management
     ...
     */
    void i(String UTCTime, String machineName, String tag, String context, String message);
     ...
     */
    void w(String UTCTime, String machineName, String tag, String context, String message);
     ...
     */
    void d(String UTCTime, String machineName, String tag, String context, String message);
