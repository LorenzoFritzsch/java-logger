...
@Component
public class ErrorUseCase implements UseCase<LogParams>{

    final LoggerRepository repository;

    @Autowired
    public ErrorUseCase(LoggerRepositoryImpl repository){
        this.repository = repository;
    }

    @Override
    public void call(LogParams logParams) {
        repository.e(logParams.getUTCDate(), logParams.getTag(), logParams.getMethod(), logParams.getMessage());
    }
